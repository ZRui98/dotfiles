...
static const uint8_t borders[] = {7,10,1,3};
...
static const char *term[]   		= { "/home/ciguatera/scripts/create_term.sh", NULL };
static const char *vol_up[]   		= { "/home/ciguatera/scripts/sound.sh", "-i", NULL };
static const char *vol_down[]   	= { "/home/ciguatera/scripts/sound.sh", "-d", NULL };
static const char *toggle_vol[]   	= { "/home/ciguatera/scripts/sound.sh", "-m", NULL };
...
static key keys[] = {
    ...
    {  0 ,                XF86XK_AudioMute,          		start,             	{.com = toggle_vol}},
